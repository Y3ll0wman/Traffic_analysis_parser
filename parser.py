...
class TrafficParser:
    ...
    def average_data_rate(self):
        ...
        average_data_rate_result = self.total_data_size / self.total_time

        return f"Средняя скорость передачи данных всей наблюдаемой сети: {average_data_rate_result} байт/сек"
